...
// JavaScript for login button interaction

// Get the login button, login form, and close button
...
loginBtn.addEventListener('click', function () {
  loginForm.style.display = 'flex'; // Show the form with flexbox
});
...
// Optional: Close the login form if clicked outside of it
window.addEventListener('click', function (event) {
  if (event.target === loginForm) {
    loginForm.style.display = 'none'; // Hide the form if clicked outside
  }
});
